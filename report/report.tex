...
\imagemfoto{0.6\textwidth}{prototipo em dev board.jpeg}{Fotografia do circuito montado em placa de desenvolvimento (Protótipo 0).}
...
\imagemfoto{0.55\textwidth}{display (sem tempos registados).jpg}{Fotografia do ecrã LCD (ainda sem tempos registados).}
...
\imagemfoto{0.6\textwidth}{caixa a carregar.jpg}{Fotografia da caixa a carregar.}
...
\imagemfoto{0.5\textwidth}{Divisor de tensao (foto).jpg}{Fotografia do circuito do divisor de tensão.}
...
\imagemfoto{0.6\textwidth}{interior da caixa.jpg}{Fotografia do interior da caixa, já com todos os componentes montados.}

\imagemfoto{0.5\textwidth}{caixa de frente.jpg}{Fotografia da caixa vista de frente.}

\imagemfoto{0.55\textwidth}{projeto em funcionamento.jpg}{Fotografia do projeto em funcionamento.}
...
\imagemfoto{0.6\textwidth}{prototipo em dev board (vista de cima).jpeg}{Fotografia do Protótipo 0 em placa de desenvolvimento (vista de cima).}

\imagemfoto{0.55\textwidth}{prototipo 0 e caderno.jpeg}{Fotografia do Protótipo 0 junto ao caderno de anotações do desenvolvimento.}
