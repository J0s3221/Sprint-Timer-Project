...
% ---------- Fotografia real (com legenda) ----------
\newcommand{\imagemfoto}[3]{
  \begin{figure}[H]
    \centering
    \includegraphics[width=#1,height=9cm,keepaspectratio]{#2}
    \caption{#3}
  \end{figure}
}
...
\imagemfoto{0.6\textwidth}{protopito_0.jpeg}{Fotografia do circuito montado em placa de desenvolvimento (Protótipo 0).}
...
\imagemfoto{0.55\textwidth}{display__sem_tempos_registados_.jpg}{Fotografia do ecrã LCD (ainda sem tempos registados).}
...
\imagemfoto{0.6\textwidth}{caixa_a_carregar.jpg}{Fotografia da caixa a carregar.}
...
\imagemfoto{0.5\textwidth}{Divisor_de_tensao__foto_.jpg}{Fotografia do circuito do divisor de tensão.}
...
\imagemfoto{0.6\textwidth}{interior_da_caixa.jpg}{Fotografia do interior da caixa, já com todos os componentes montados.}

\imagemfoto{0.5\textwidth}{caixa_de_frente.jpg}{Fotografia da caixa vista de frente.}

\imagemfoto{0.55\textwidth}{projeto_em_funcionamento.jpg}{Fotografia do projeto em funcionamento.}
...
\imagemfoto{0.6\textwidth}{prototipo_em_dev_board__vista_de_cima_.jpeg}{Fotografia do Protótipo 0 em placa de desenvolvimento (vista de cima).}

\imagemfoto{0.6\textwidth}{prototipo_em_dev_board.jpeg}{Fotografia do Protótipo 0 em placa de desenvolvimento.}

\imagemfoto{0.55\textwidth}{prototipo_0_e_caderno.jpeg}{Fotografia do Protótipo 0 junto ao caderno de anotações do desenvolvimento.}
